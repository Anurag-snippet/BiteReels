...
const Home = () => {
    ...
    useEffect(() => {
        axios.get('https://bitereels-backend-iuva.onrender.com/api/auth/me', { withCredentials: true })
            .then(response => {
    ...
    const fetchVideos = (tab) => {
        const endpoint = tab === 'home' 
            ? 'https://bitereels-backend-iuva.onrender.com/api/food' 
            : 'https://bitereels-backend-iuva.onrender.com/api/save/items';
    ...
    const handleLikeToggle = async (videoId, index) => {
        ...
        try {
            const response = await axios.post(`https://bitereels-backend-iuva.onrender.com/api/likes/toggle/${videoId}`, {}, { withCredentials: true });
    ...
    const handleSaveToggle = async (videoId, index) => {
        ...
        try {
            const response = await axios.post(`https://bitereels-backend-iuva.onrender.com/api/save/toggle/${videoId}`, {}, { withCredentials: true });
    ...
    const handleOpenComments = async (video) => {
        ...
        try {
            const response = await axios.get(`https://bitereels-backend-iuva.onrender.com/api/comment/${video._id || video.id}`, { withCredentials: true });
    ...
    const handlePostComment = async (e) => {
        ...
        try {
            const response = await axios.post(`https://bitereels-backend-iuva.onrender.com/api/comment/${videoId}`, {
                text: newCommentText
    ...
    const handleLogout = async () => {
        try {
            const logoutUrl = session.role === 'partner' 
                ? 'https://bitereels-backend-iuva.onrender.com/api/auth/food-partner/logout'
                : 'https://bitereels-backend-iuva.onrender.com/api/auth/user/logout';
